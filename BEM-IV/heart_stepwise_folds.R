...
totalIV <- matrix()
for (i in 1:kfolds) { 
  file_name <- paste("/home/david/R/PaperR/TestData/KFoldsCVSMOTE/Heart/DataSets/train_smote_heart_fold_", i, sep = "")
...
#  View(data_train)
  ...
  model_name <- paste("/home/david/R/PaperR/TestData/KFoldsCVSMOTE/Heart/BEM/stepwise_model_heart_fold_", i, sep = "")
