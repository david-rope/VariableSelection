...
print(total_time)
results <- list(target_train = data_train$Class, predic_train = result.train,
                target_test = data_test$Class, predic_test = result.test, 
                tiempo = total_time)

saveRDS(results,
        "/data1/David/OutputR/KFoldsCV/Fraud/SVM/Fold5/SVM_results_fraud_iv_NVAR.rds")
saveRDS(svm.model, "/data1/David/OutputR/KFoldsCV/Fraud/SVM/Fold5/SVM_model_fraud_iv_NVAR.rds")
