...
print(total_time)
results <- list(target_train = data_train$target, predic_train = predic.train,
                target_test = data_test$target, predic_test = predic.test, 
                tiempo = total_time)

saveRDS(results,
        "/data1/David/OutputR/KFoldsCV/Heart/DT/Fold5/DT_results_heart_iv_NVAR.rds")
saveRDS(dt.model, "/data1/David/OutputR/KFoldsCV/Heart/DT/Fold5/DT_model_heart_iv_NVAR.rds")
