...
saveRDS(results,
        "/data1/David/OutputR/KFoldsCV/Higgs/MLP/Fold5/MLP_results_higgs_iv_NVAR.rds")
saveRDS(snns.model, "/data1/David/OutputR/KFoldsCV/Higgs/MLP/Fold5/MLP_model_higgs_iv_NVAR.rds")
