...
filename=./IVRank/IV_pulsar_fold_5.txt
...
while read line; do
   ...
   cp  ${SCRIPT}.R ./ScriptsSVM_F5/${SCRIPT}_${nvar}.R
   sed -i s/NVAR/${nvar}/ ./ScriptsSVM_F5/${SCRIPT}_${nvar}.R 
