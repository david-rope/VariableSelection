...
saveRDS(results,
        "/data1/David/OutputR/KFoldsCV/Fraud/MLP/Fold5/MLP_results_fraud_iv_NVAR.rds")
saveRDS(snns.model, "/data1/David/OutputR/KFoldsCV/Fraud/MLP/Fold5/MLP_model_fraud_iv_NVAR.rds")
